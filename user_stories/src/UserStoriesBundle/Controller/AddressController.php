...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $addresses = $em->getRepository('UserStoriesBundle:Address')->findAll();
     ...
     *
     * @Route("/{id}/modify", name="address_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Address $address)
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('UserStoriesBundle\Form\AddressType', $address);
